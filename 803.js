$(function() {
	...
	$("#803btn")[0].onclick = function() {
		if (status != 0) return;
		status = 1
		$("#803").css("display", "block").animate({top: "144px", opacity: "1"}, 800, function() {
			status = 2
		})
	}
